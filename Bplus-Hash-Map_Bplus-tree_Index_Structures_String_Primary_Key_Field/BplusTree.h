...
typedef struct TableD_RecordData* TableD_RecordData;
...
/* Record data - row of the table TableD that is linked to the Bplus-tree index structure. */

struct TableD_RecordData
{
